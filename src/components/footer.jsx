...
export default function Footer() {
  return (
    <>
      <section className="footer animated fadeIn">
          ...
          <div className="container d-flex justify-content-around">
            <div className="col f-1 d-flex flex-column align-items-center">
              <div className="text-footer">
                <p className="text-white gap">lorem ipsum dolor <br />
                  sit amet juhb bushid
                </p>
              </div>
              <img className="my-3" style={{ width: "100px" }} alt="logo" src={logo}></img>
              <p className="text-white">
                copyright @Archicart 2022
              </p>
            </div>
            ...
            <div className="col d-flex flex-column align-items-center">
              <div className="gap d-flex text-white">
                <a className="mx-2" href="https://www.twitter.com">
                ...
                <a className="mx-2" href="https://www.onlyfans.com">
